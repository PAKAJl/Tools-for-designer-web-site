...
<body>
    ...
    <section class="cards" id="cards">
        <div class="wrapper">
            ...
            <div class="cards__content cards__content--s-icons hidden">
                <a class="cards__link cards__link--social cards__link--social1 JSsolcial1" href="#">
                ...
                <a class="cards__link cards__link--social cards__link--social2 JSsolcial2" href="#">
                    <img class="cards__img-s" src="/Resoures/Pictures/s2.png" alt="Набор иконок" width="200px" height="111px">
                    <p class="cards__name">Social icons</p>
                    <p class="cards__type">color</p>
                </a>
                <a class="cards__link cards__link--social cards__link--social3 JSsolcial3" href="#">
                ...
                <a class="cards__link cards__link--social cards__link--social4 JSsolcial4" href="#">
    ...
    <div class="overlay hidden">
        ...
        <div class="modal modal-photo JSmodal JSsocial1 hidden">
            <h4 class="modal__header">Жывотные</h4>
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link">@wirestock</a></p>
            <div class="division modal__images">
        ...
        <div class="modal modal-photo JSmodal JSsocial2 hidden">
            <h4 class="modal__header">Жывотные</h4>
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link">@wirestock</a></p>
            <div class="division modal__images">
        ...
        <div class="modal modal-photo JSmodal JSsocial3 hidden">
            <h4 class="modal__header">Жывотные</h4>
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link">@wirestock</a></p>
            <div class="division modal__images">
        ...
        <div class="modal modal-photo JSmodal JSsocial4 hidden">
            <h4 class="modal__header">Жывотные</h4>
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link">@wirestock</a></p>
            <div class="division modal__images">
