...
<body>
    ...
    <footer class="footer">
        <div class="footer__container">
            ...
            <div class="footer__social">
                ...
                <a class="footer__link" href="https://instagram.com/marryyart.design"><img class="footer__icon" src="/Resoures/Pictures/instagram.png" alt="Instagram" width="34px" height="34px"></a>
    ...
    <div class="overlay hidden">
        <div class="modal modal-photo JSmodal JSpeoples hidden">
            <img class="cross" src="/Resoures/Pictures/cross.png" alt="">
            <h4 class="modal__header">Люди</h4>
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://ru.freepik.com/senivpetro">@senivpetro</a></p>
            <div class="division modal__images">
                <img src="/Resoures/Pictures/peoplesmodal.png" alt="Люди">
            </div>

            <a id="button" class="button-modal modal__button" href="/Resoures/Download/Люди.rar">
        ...
        <div class="modal modal-photo JSmodal JSwild hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://ru.freepik.com/wirestock">@wirestock</a></p>
            <div class="division modal__images">
                <img src="/Resoures/Pictures/wildmodal.png" alt="Природа">
            </div>
            <a id="button" class="button-modal modal__button" href="/Resoures/Download/Природа.rar">
                <p class="button-text">Скачать</p>
            </a>
        </div>
        <div class="modal modal-photo JSmodal JSanimals hidden">
            ...
            <a id="button" class="button-modal modal__button" href="/Resoures/Download/Животные.rar">
                <p class="button-text">Скачать</p>
            </a>
        </div>
        <div class="modal modal-photo JSmodal JSmok hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://ru.freepik.com/mego-studio">@mego-studio</a></p>
            <div class="division modal__images">
                <img src="/Resoures/Pictures/mokupsmodal.png" alt="Мокапы">
            </div>
            <a id="button" class="button-modal modal__button" href="/Resoures/Download/Мокапы.rar">
                <p class="button-text">Скачать</p>
            </a>
        </div>
        <div class="modal modal-photo JSmodal JSagency hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="http://psdboom.com/author/rayhan">@Al Rayhan</a></p>
            <div class="division modal__images">
                <?php
                        foreach ($images as $i){
                        if ($i->number == 1){?>
        ...
        <div class="modal modal-photo JSmodal JSboostpolia hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://www.behance.net/ferdauskabiremon">@Ferdaus Kabir Emon</a></p>
            <div class="division modal__images">
                <?php
                foreach ($images as $i){
                    if ($i->number == 2){?>
        ...
        <div class="modal modal-photo JSmodal JSpiroll hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://dribbble.com/sudinasa">@Svitlana</a></p>
            <div class="division modal__images">
                <?php
                foreach ($images as $i){
                    if ($i->number == 3){?>
        ...
        <div class="modal modal-social JSmodal JSsocial1 hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://dribbble.com/madsegmose">@madsegmose</a></p>
            <div class="division modal__images">
                <?php
                foreach ($images as $i){
                    if ($i->number == 5){?>
            ...
            <a id="button" class="button-modal modal__button" href="/Resoures/Download/<?=htmlspecialchars($row->downLink)?>">
                <p class="button-text">Скачать</p>
            </a>
        </div>
        ...
        <div class="modal modal-social JSmodal JSsocial3 hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://www.instagram.com/_phosphoricons/">@Phosphor Icons</a></p>
            <div class="division modal__images">
                <?php
                foreach ($images as $i){
                    if ($i->number == 6){?>
        ...
        <div class="modal modal-photo JSmodal JSillust1 hidden">
            <img class="cross" src="/Resoures/Pictures/cross.png" alt="">
            <h4 class="modal__header">Blue Monday</h4>
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://ru.freepik.com/freepik">@freepik</a></p>
            <div class="division modal__images">
                <img src="/Resoures/Pictures/illust1modal.png" alt="Иллюстрации">
            </div>
            <a id="button" class="button-modal modal__button" href="/Resoures/Download/BLUE MONDAY.rar">
                <p class="button-text">Скачать</p>
            </a>
        </div>
        <div class="modal modal-photo JSmodal JSillust2 hidden">
            ...
            <p class="modal__text">Бесплатно для личного и коммерческого использования с атрибуцией.</p>
            <p class="modal__author">Автор: <a class="modal__link" href="https://ru.freepik.com/pikisuperstar">@pikisuperstar</a></p>
            <div class="division modal__images">
                <img src="/Resoures/Pictures/illust2modal.png" alt="Иллюстрации">
            </div>
            <a id="button" class="button-modal modal__button" href="/Resoures/Download/Ethical Dilemma.rar">
                <p class="button-text">Скачать</p>
            </a>
        </div>
    </div>
